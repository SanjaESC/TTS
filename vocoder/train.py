...
from TTS.vocoder.datasets.preprocess import load_wav_data, load_wav_feat_data, load_training_data_file
...
def main(args):  # pylint: disable=redefined-outer-name
    ...
    global train_data, eval_data, ap
    # temp_eval_data, temp_train_data = load_wav_data(c.data_path, c.eval_split_size)
    eval_data, train_data = load_training_data_file(c.data_path, c.eval_split_size)
    ...
    print(f' > Training data: {len(train_data)} train instances.')
    print(f' > Evaluation data: {len(eval_data)} eval instances.')
